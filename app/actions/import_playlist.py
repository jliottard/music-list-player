''' Playlist "import" command functionalities '''
...
def import_playlist(args: list, configuration: Configuration, current_player: AudioPlayer, 
    user_interface: Interface) -> AudioPlayer:
    """Get playlist contents from the args' profile and load the player for the audios
    If the args is only containing the import keyword, it loads the whole audio list
     into a new playlist.
